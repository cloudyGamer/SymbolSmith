...
$('#imgTag1').append($("<img src='https://s3.eu-west-1.amazonaws.com/symbolsmith/"+imgAdArray[index]+"' id='imgIdTop"+index+"' class='periodStyle' alt=''/>").width(65).height(65));    //it appears in this div //where you resize choosen mark
...
//$('#Period').append("<p>"+symbol.lonPeriod+"<p>"); //this will give you years. change the div to where you want them to appear
    ...
    $('#imgTag4').empty();
$('#imgTag4').append("<img src='https://s3.eu-west-1.amazonaws.com/symbolsmith/"+stanImgAdArray[index]+"' id='imgIdStandardTop"+index+"'  alt=''/>");    //width amd height = 65it appears in this div
...
//$("#imgIdLetter"+index+"").addClass("letterStyle");
    ...
    $('#imgTag3').empty();
$('#imgTag3').append("<img src='https://s3.eu-west-1.amazonaws.com/symbolsmith/"+newImgAd+"' id='imgIdDutyTop"+index+"' alt=''/>");    //it appears in this div
...
//$("#imgIdLetter"+index+"").addClass("letterStyle");
    ...
    $(clickedImage).empty();
$(clickedImage).append($("<img src='https://s3.eu-west-1.amazonaws.com/symbolsmith/"+newImgAd+"'id='imgIdLetterTop"+index+"' alt='' style='opacity: 0;'    />").width(65).height(65));
